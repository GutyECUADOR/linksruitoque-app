    ...
    <div class="container">
        <div class="row mb-8 justify-content-center">
            <div class="col-lg-6 col-md-12 col-12 text-center">
                <!-- caption -->
                <span class="text-primary mb-3 d-block text-uppercase fw-semibold ls-xl">Lo que necesitas saber</span>
                <h2 class="mb-2 display-4 fw-bold ">Preguntas frecuentes.</h2>
                <p class="lead">Consulta nuestra guía de preguntas frecuentes.</p>
            </div>
        </div>
        <!-- row -->
            ...
            <div class="col-lg-6 col-md-8 col-12">
                <div class="accordion accordion-flush" id="accordionfaq">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="py-3 fs-4">
                            GUO PAGOS es la plataforma de pagos electrónicos que usa LINKRUITOQUE para procesar en línea las transacciones generadas en la tienda virtual con
                            las formas de pago habilitadas para tal fin.
                        </div>
                    </div>
                    <!-- Card  -->
                    <!-- Card header  -->
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                        data-bs-parent="#accordionfaq">
                        <div class="py-3 fs-4">
                            Para proteger tus datos LINKRUITOQUE delega en GOU pagos la
                            ...
                            manera te podrás sentir seguro a la hora de ingresar la información de su tarjeta.
                            ...
                            completar la transacción en GOU Pagos.
                            GOU Pagos también cuenta con el monitoreo constante de McAfee Secure y la firma de
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                        data-bs-parent="#accordionfaq">
                        <div class="py-3 fs-4">
                            Sí, en LINKRUITOQUE podrás realizar tus compras en línea los 7 días
                            de la semana, las 24 horas del día a sólo un clic de distancia.
                        </div>
                    </div>
                    <!-- Card  -->
                    <!-- Card header  -->
                    ...
                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                        data-bs-parent="#accordionfaq">
                        <div class="py-3 fs-4">
                            Si aún no has finalizado tu pago, podrás volver al paso inicial y elegir la forma de pago
                            que prefieras. Una vez finalizada la compra no es posible cambiar la forma de pago.
                            ESTABLECIMIENTO DE COMERCIO: el punto anterior aplica a la forma de pago, pero
                            deberán mencionar las políticas de devolución que tenga la tienda para dar
                            cumplimiento al artículo 51 de la Ley del Estatuto del Consumidor.
                        </div>
                    </div>
                     <!-- Card  -->
                    <!-- Card header  -->
                    <div class="pt-3" id="headingFive">
                        <h3 class="mb-0 fw-bold">
                            <a href="#" class="d-flex align-items-center text-inherit text-decoration-none active"
